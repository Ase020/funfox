...
const Week1 = () => {
  return (
    <div className="w-[calc(100%-112px)] h-[694px] rounded-[20px] mx-auto bg-white p-5 flex flex-col items-center justify-center gap-2.5">
      ...
      <h3 className="text-center bg-pink-dark text-white text-2xl lg:text-32 leading-9 py-2 px-4 rounded-3xl border-4 border-pink-primary border-dashed shadow-xl">
      ...
      <div className="bg-green-2 border-4 border-dashed border-green-1 h-28 flex items-center text-white p-1.5 lg:p-3">
        ...
        <img src={child} alt="child" className="object-contain lg:mt-3" />
      </div>
      ...
      <div className="h-48 lg:h-32 relative">
        <img src={pulp} alt="pulp" className="h-full hidden lg:flex" />
        <img src={pulpMobile} alt="pulp" className="h-full flex lg:hidden" />
        <p className="absolute inset-x-8 lg:inset-x-16 inset-y-10 lg:inset-y-2 text-base lg:text-xl">
